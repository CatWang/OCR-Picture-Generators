...
# fontDir, modify it to the correct path
...
# all letters and combinations that are needed
...
with open('water10w.csv', 'w') as csvfile:
    csvfile.write('%s %s\n' % ('filename', 'string'))
	...
	# the directory containing the background picutres
	# you can modify it if you like
		...
		#the transparent rate is randomly picked
                ...
                filename = 'water10w/' + str(index) + '.jpg'
